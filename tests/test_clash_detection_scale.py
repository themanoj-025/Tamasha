...
- Completion under a generous time threshold (8 seconds on reasonable hardware)
- Correctness of same-day release detection

Gated behind the ``scale`` marker so CI stays green on slow machines.
Run explicitly with:  pytest -m scale
"""
