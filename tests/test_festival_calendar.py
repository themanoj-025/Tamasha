...
class TestFestivalCalendar:
    ...
    def test_get_major_release_windows_returns_dict(self) -> None:
    ...
    def test_is_festival_release_exact_match(self) -> None:
        windows = get_major_release_windows(2024)
        # Christmas
    ...
    def test_is_festival_release_near_match(self) -> None:
        windows = get_major_release_windows(2024)
    ...
    def test_is_festival_release_no_match(self) -> None:
        windows = get_major_release_windows(2024)
...
class TestComputeClashFeature:
    ...
    def test_no_clash_when_far_apart(self) -> None:
        df = pd.DataFrame(
            {
                "title": ["Movie A", "Movie B"],
